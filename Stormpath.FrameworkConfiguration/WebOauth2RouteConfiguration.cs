...
namespace Stormpath.Framework.Configuration
{
    ...
    {
        public WebOauth2ClientCredentialsGrantConfiguration ClientCredentials { get; private set; }

        public WebOauth2PasswordGrantConfiguration Password { get; private set; }
    }
}
