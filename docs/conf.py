...
# Use the tag passed to make html to determine the project name
if tags.has('aspnetcore'):
    project_shortname = u'ASP.NET Core'
elif tags.has('nancy'):
    project_shortname = u'Nancy Library Guide'
elif tags.has('aspnet'):
    project_shortname = u'ASP.NET Library Guide'
else:
    raise ValueError('Unknown framework tag.')

project = u'%s Library Guide' % project_shortname
...
htmlhelp_basename = 'Express-Stormpathdoc'
