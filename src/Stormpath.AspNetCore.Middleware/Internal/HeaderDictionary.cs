...
namespace Stormpath.AspNetCore.Internal
{
    ...
    public class HeaderDictionary : IHeaderDictionary
    {
        ...
        private static readonly ICollection<string[]> EmptyValues = new List<string[]>();
        ...
        public HeaderDictionary(Dictionary<string, string[]> store)
        {
            Store = store;
        }
        ...
        public string[] this[string key]
        {
            ...
            set
            {
                ...
                bool isNullOrEmpty = value == null || value.All(x => string.IsNullOrEmpty(x));
                ...
                else
                {
                    if (Store == null)
                    {
                        Store = new Dictionary<string, string[]>(1, StringComparer.OrdinalIgnoreCase);
                    }
        ...
        public void Add(string key, string[] value)
        {
            ...
            if (Store == null)
            {
                Store = new Dictionary<string, string[]>(1);
            }
            Store.Add(key, value);
        }
        ...
        public bool Remove(KeyValuePair<string, string[]> item)
        {
            ...
            if (Store.TryGetValue(item.Key, out value) && value.SequenceEqual(item.Value))
            {
